...
const pricingInfo: TPricing[] = [
  {
    ...
    <ul>
      ...
      <li>тем, кто хочет работать в&nbsp;комфортном для&nbsp;тебя темпе;</li>
    ...
    <p>
      * При единовременной оплате сертификата на&nbsp;4 занятия стоимость 1 занятия составит <b>1400 рублей</b>.
      Срок действия сертификата составляет 30 дней. Общая стоимость сертификата составит 5750 рублей.
    </p>
    <p>
      * При единовременной оплате сертификата на&nbsp;8 занятий стоимость 1 занятия составит <b>1375 рублей</b>.
