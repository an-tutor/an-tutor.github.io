...
const pricingInfo: TPricing[] = [
  {
    ...
    description: /*html*/ `<p>Кому подходит этот формат?</p>
    <ul>
    ...
    <h4>Стоимость</h4>
    <p>Индивидуальное занятие «Подготовка к&nbsp;ОГЭ» (60 минут)&nbsp;/ <b>2&nbsp;100&nbsp;рублей</b>.</p>
    <p>
      * При единовременной оплате сертификата на&nbsp;4 занятия стоимость 1 занятия составит <b>2&nbsp;050&nbsp;рублей</b>.
      Срок действия сертификата составляет 30 дней. Общая стоимость сертификата составит 8&nbsp;200&nbsp;рублей.
    </p>
    <p>
      * При единовременной оплате сертификата на&nbsp;8 занятий стоимость 1 занятия составит <b>2&nbsp;000&nbsp;рублей</b>.
      Срок действия сертификата составляет 30 дней. Общая стоимость сертификата составит 16&nbsp;000&nbsp;рублей.
    </p>
  ...
  },
  {
    ...
    <h4>Стоимость</h4>
    <p>Парные занятия «Подготовка к ОГЭ» (60 минут) оплачиваются сертификатами единовременно. Срок действия сертификата&nbsp;- 30&nbsp;дней.</p>
    <p>Стоимость сертификата на&nbsp;4 занятия составляет 4&nbsp;800&nbsp;рублей, 1 занятие&nbsp;– <b>1&nbsp;200&nbsp;рублей</b>.</p>
    <p>Стоимость сертификата на&nbsp;8 занятий составляет 8&nbsp;800&nbsp;рублей, 1 занятие&nbsp;– <b>1&nbsp;100&nbsp;рублей</b>.</p>
    <p style="margin-top: 12px">Групповые занятия «Подготовка к ОГЭ» (60 минут) оплачиваются сертификатами единовременно. Срок действия сертификата&nbsp;- 30&nbsp;дней.</p>
    <p>Стоимость сертификата на&nbsp;4 занятия составляет 3&nbsp;400&nbsp;рублей, 1 занятие&nbsp;– <b>850&nbsp;рублей</b>.</p>
    <p>Стоимость сертификата на&nbsp;8 занятий составляет 6&nbsp;400&nbsp;рублей, 1 занятие&nbsp;– <b>800&nbsp;рублей</b>.</p>
    <h4>Что вы&nbsp;получите?</h4>
    <ul>
  ...
  },
  {
    ...
    <h4>Стоимость</h4>
    <p>Индивидуальное занятие «Повышение успеваемости» (60 минут)&nbsp;/ 1&nbsp;900&nbsp;рублей.</p>
    <p>
      * При единовременной оплате сертификата на 4 занятия стоимость 1 занятия составит <b>1&nbsp;850&nbsp;рублей</b>.
      Срок действия сертификата составляет 30 дней. Общая стоимость сертификата составит 7&nbsp;400&nbsp;рублей.
    </p>
    <p>
      * При единовременной оплате сертификата на 8 занятий стоимость 1 занятия составит <b>1&nbsp;800&nbsp;рублей</b>.
      Срок действия сертификата составляет 30 дней. Общая стоимость сертификата составит 14&nbsp;400&nbsp;рублей.
    </p>
    <h4>Что вы получите?</h4>
    <p>Доступ к&nbsp;платформе с&nbsp;материалами, домашними заданиями и отслеживанием прогресса обучения.</p>
    <h4>Пробное занятие</h4>
  ...
  <li>
    ...
    <h4>Стоимость</h4>
    <p>Стоимость консультации составляет <b>4&nbsp;000&nbsp;рублей</b>&nbsp;/ 1,5&nbsp;часа.</p>
    `,
  },
];
...
const process: { title: string; description: string } = {
  ...
  <p>
    ...
    через&nbsp;платформу Zoom/Яндекс Телемост.
  </p>
